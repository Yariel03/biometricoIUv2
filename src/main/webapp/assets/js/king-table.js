$(document).ready(function(){
	...
	if( $('#featured-datatable1').length > 0 ) {
	...
	if( $('#featured-datatable3').length > 0 ) {
		$('#featured-datatable3').dataTable({
			sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
		});
	}
	if( $('#featured-datatable4').length > 0 ) {
		$('#featured-datatable4').dataTable({
			sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
		});
	}
	if( $('#featured-datatable5').length > 0 ) {
		$('#featured-datatable5').dataTable({
			sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
		});
	}
	if( $('#featured-datatable6').length > 0 ) {
		$('#featured-datatable6').dataTable({
			sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
		});
	}
	if( $('#featured-datatable7').length > 0 ) {
		$('#featured-datatable7').dataTable({
			sDom: "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
		});
	}
